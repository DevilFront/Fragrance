                        ...
                        <div class="tablewarp">
                            ...
                            <table class="table-part1">
                                ...
                                <tr>     
                                    ...
                                    <td class="info-con">
                                          <input value ="${n.name}" type="text" name="name" id="input" required>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="info-tit">브랜드명</td>
                                    <td class="info-con">
                                       <input value ="${n.brand}" type="text" name="brand" id="input" required>
                                    </td>
                                </tr>
                                <tr>
                            ...
                            <table class="table-part2">
                                ...
                                <tr>
                                    ...
                                    <td class="info-con rightnone" colspan="3">
                                       <input  value ="${n.content}" type="text" name="content" id="input" required>
                                    </td>
                                </tr>
                                <tr>
